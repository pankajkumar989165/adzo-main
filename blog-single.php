...
<head>
    ...
    <meta property="og:title" content="<?php echo htmlspecialchars($blog['og_title'] ?: $blog['title']); ?>">
    <meta property="og:description"
        content="<?php echo htmlspecialchars($blog['og_description'] ?: $meta_description); ?>">
    <?php if ($og_image): ?>
    ...
    <meta property="twitter:title" content="<?php echo htmlspecialchars($blog['og_title'] ?: $blog['title']); ?>">
    ...
    <script type="application/ld+json">
    {
      ...
      "author": {
        "@type": "Person",
        "name": "<?php echo addslashes($blog['author_name']); ?>"
      },
      "publisher": {
        "@type": "Organization",
                ...
                <?php if (!empty($tags)): ?>
                    <div class="post-tags">
                        <?php foreach ($tags as $tag): ?>
                            <a href="<?php echo SITE_URL; ?>/blog.php?search=<?php echo urlencode($tag['name']); ?>"
                                class="tag">#
